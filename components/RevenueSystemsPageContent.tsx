...
export function RevenueSystemsPageContent() {
  return (
    <main className="marketing-site">
      ...
      <section className="marketing-page-section shell compact-top">
        <div className="marketing-head-grid">
          <span className="section-number">Unique data</span>
      ...
      <section className="marketing-page-section dark-band">
        <div className="shell">
          <div className="marketing-head-grid">
            <span className="section-number light">AI with control</span>
      ...
      <section className="marketing-page-section shell">
        <div className="marketing-head-grid">
          <span className="section-number">Works with your stack</span>
      ...
      <section className="marketing-page-section shell compact-top">
        <div className="marketing-head-grid">
          <span className="section-number">Measurement</span>
      ...
      <section className="marketing-page-section shell compact-top">
        <div className="marketing-head-grid">
          <span className="section-number">Fit</span>
